    ...
    <div class="col-sm-12 col-md-8 col-lg-6">
				<div class="panel panel-primary">
					...
					<div class="panel-body">
                            ...
                            <asp:Button ID="btnsub" runat="server" class="btn btn-default" Text="Aceptar" OnClick="btnsub_Click"/>
							&nbsp;&nbsp;&nbsp;
							<button type="reset" class="btn btn-default">Cancelar</button>
					        <br />
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TribunalesDB2ConnectionString %>" SelectCommand="SELECT * FROM [Activo]"></asp:SqlDataSource>
					        <br />
